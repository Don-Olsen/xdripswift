...
extension Calibrator {
    ...
    /// Reuse the normal value calculation for backfill without treating delayed samples as new
    /// calibration evidence. Factory mode still uses NoCalibrator's unchanged implementation.
